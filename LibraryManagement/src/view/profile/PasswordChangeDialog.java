...
public class PasswordChangeDialog extends javax.swing.JDialog {
    ...
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
		...
		System.out.println("Pass cu: " + pwdOld);
		System.out.println("Pass confirm: " + passwordConfirm);
        if(!pwdOld.equals(passwordConfirm)){
...
//                  ps.setString(1, hash(pwdNew));
    ...
    String getPassword(String username){
        ...
        Connection ketNoi= Connect.GetConnect();
        try {
            PreparedStatement ps=ketNoi.prepareStatement("select account_password from account where account_username = ?");
            ...
            System.out.println("loi lay password");
        }
        return "";
    }
